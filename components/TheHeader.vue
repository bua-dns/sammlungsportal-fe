<template>
  <header class="navbar fixed-top">
    <nuxt-link to="/" class="navbar__brand" v-if="true">
      <svg v-if="false" viewBox="0 0 76 76" version="1.1" xmlns="http://www.w3.org/2000/svg"
        xmlns:svg="http://www.w3.org/2000/svg" class="navbar__logo">
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 119 89.25" class="navbar__logo">
        ...
        <line x1="50.08" y1="45.12" x2="93.71" y2="18.35"
          style="fill: #525252; stroke: #525252; stroke-miterlimit: 10; stroke-width: 5px;" />
        <circle cx="22.04" cy="20.29" r="18.84" style="fill: #848f7f; stroke-width: 0;" />
        <line x1="17.35" y1="71.9" x2="49.09" y2="45.12"
          style="fill: #525252; stroke: #525252; stroke-miterlimit: 10; stroke-width: 5px;" />
        <circle cx="49.09" cy="45.12" r="12.4" style="fill: #525252; stroke-width: 0;" />
        <circle cx="93.22" cy="18.84" r="18.84" style="fill: #9acd00; stroke-width: 0;" />
        <circle cx="18.84" cy="70.41" r="18.84" style="fill: #c30e20; stroke-width: 0;" />
        <circle cx="100.16" cy="63.47" r="18.84" style="fill: #00376b; stroke-width: 0;" />
      </svg>
